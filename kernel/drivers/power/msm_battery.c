...
/* BEGIN: [naveen.amarendra@lge.com]: Fix for Dload mode screen appears during charging mode. 20-06-2011 */
/* [Kernel] charging mode check command */
...
#include <linux/fs.h>
#endif
/* END: [naveen.amarendra@lge.com]: Fix for Dload mode screen appears during charging mode. 20-06-2011 */
...
// BEGIN: 0016262: hyunjong.do@lge.com 2011-02-16
// ADD: 0016262: send wireless charger status through RPC
  u32 wlc_status;
// END: 0016262: hyunjong.do@lge.com 2011-02-16
};
...
// BEGIN: 0016859: hyunjong.do@lge.com 2011-02-23
// ADD: 0016859: [ORD] [Wireless Charging] preventing suspend while charging with wireless PAD
static struct wake_lock	wlc_wlock;
...
// BEGIN: 0016262: hyunjong.do@lge.com 2011-02-16
// ADD: 0016262: send wireless charger status through RPC
		be32_to_cpu_self(v1p->wlc_status);
// END: 0016262: hyunjong.do@lge.com 2011-02-16
#endif
	} else {
...
// BEGIN: 0016262: hyunjong.do@lge.com 2011-02-16
// ADD: 0016262: send wireless charger status through RPC
	wlc_status = rep_batt_chg.v1.wlc_status;
// END: 0016262: hyunjong.do@lge.com 2011-02-16
// END:  0010099 hyunjong.do@lge.com 2010-10-21
/* CONFIG_MACH_LGE_BRYCE hyunjong.do@lge.com 10.08.10
   */
...
// BEGIN: 0016262: hyunjong.do@lge.com 2011-02-16
// ADD: 0016262: send wireless charger status through RPC
	    wlc_status == msm_batt_info.wlc_status &&
// END: 0016262: hyunjong.do@lge.com 2011-02-16
...
// BEGIN: 0016262: hyunjong.do@lge.com 2011-02-16
// ADD: 0016262: send wireless charger status through RPC
	msm_batt_info.wlc_status = rep_batt_chg.v1.wlc_status;
// END: 0016262: hyunjong.do@lge.com 2011-02-16
...
/* ADD: [naveen.amarendra@lge.com]: Fix for Dload mode screen appears during charging mode. 20-06-2011 */
/* [Kernel-start] charging mode check command */
#ifdef CONFIG_LGE_CHARGING_MODE_INFO
...
#endif
/* [Kernel-end] charging mode check command */
...
/* CONFIG_MACH_LGE_BRYCE hyunjong.do@lge.com 10.08.10
   */
		...
		pr_info("%s: power_supply_register success"
				" rc = %d\n", __func__, rc);
#endif
...
/* CONFIG_MACH_LGE_BRYCE hyunjong.do@lge.com 10.08.10
   */
		...
		pr_info("%s: External Power supply(AC or USB)"
			"is avilable\n", __func__);
#endif
...
/* CONFIG_MACH_LGE_BRYCE hyunjong.do@lge.com 10.08.10
   */
		...
		pr_info("%s: msm_batt_register   success	rc=%d\n", __func__, rc);
#endif
...
/* CONFIG_MACH_LGE_BRYCE hyunjong.do@lge.com 10.08.10
   */
		...
		pr_info("%s: msm_batt_enable_filter success rc=%d\n", __func__, rc);
#endif
...
/* CONFIG_MACH_LGE_BRYCE hyunjong.do@lge.com 10.08.10
   */
		...
		pr_info("%s: msm_batt_cleanup  success  rc=%d\n", __func__, rc);
#endif
...
/* CONFIG_MACH_LGE_BRYCE hyunjong.do@lge.com 10.08.10
   */
	...
	{
		pr_info("%s: SUCCESS: platform_driver_register. rc = %d\n",
		       __func__, rc);
	}
#endif
	return rc;
...
// BEGIN: 0016859: hyunjong.do@lge.com 2011-02-23
// ADD: 0016859: [ORD] [Wireless Charging] preventing suspend while charging with wireless PAD
	wake_lock_init(&wlc_wlock,
			WAKE_LOCK_SUSPEND, "wlc_chg_active");
// END: 0016859: hyunjong.do@lge.com 2011-02-23
...
/* CONFIG_MACH_LGE_BRYCE hyunjong.do@lge.com 10.08.10
   */
		...
		pr_info("%s: SUCCESS: msm_batt_init_rpc.  rc=%d\n", __func__, rc);
	}
	// bart // CHG_RPC_VER_2_2	/	BATTERY_RPC_VER_2_1

#endif

/* BEGIN: 0015566 jihoon.lee@lge.com 20110207 */
/* ADD 0015566: [Kernel] charging mode check command */
// register charging mode notification info
#ifdef CONFIG_LGE_CHARGING_MODE_INFO
...
/* BEGIN: 0015566 jihoon.lee@lge.com 20110207 */
/* ADD 0015566: [Kernel] charging mode check command */
// deregister charging mode notification info
#ifdef CONFIG_LGE_CHARGING_MODE_INFO
	misc_deregister(&chg_logo_device);
#endif
/* END: 0015566 jihoon.lee@lge.com 20110207 */
