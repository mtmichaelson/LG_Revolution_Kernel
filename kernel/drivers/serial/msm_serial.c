...
//TODO :- need to check again with froyo. Kiran Kanneganti.
// BEGIN 0010274: eundeok.bae@lge.com 2010-10-27
// Fixed a problem that system don't go to sleep mode.	
...
{
// BEGIN 0010294: eundeok.bae@lge.com 2010-10-28
// Second, Fixed a problem that system don't go to sleep mode.
	if(!strcmp(s,"uart_disable"))
		uart_det_flag = 1;
	else if(!strcmp(s,"uart_enable"))
		uart_det_flag = 0;
// END 0010294: eundeok.bae@lge.com 2010-10-28		
	
	return 1;
}
__setup("uart.mode=",uart_mode_detect);
// fs_initcall(msm_serial_init); for reduction boot time by swift
// END 0010274: eundeok.bae@lge.com 2010-10-27
#endif
