...
/*MOD 0019235:  [LTE] Monitoring code & LTE Crash Dump Handling */
	...
	int i;
	for( i = 0 ;  i < 30 ; i++)
		gLte_sdcc_status.tracking[i]=enum_msmsdcc_max;
	//gLte_sdcc_status.function_check[enum_msmsdcc_dma_exec_func] = 1;
	gLte_sdcc_status.index=0;
	//gLte_sdcc_status.lastVisited=enum_lte_sdio_tty_write;
	gLte_sdcc_status.tracking[gLte_sdcc_status.index] = enum_lte_sdio_tty_write;
	if(gLte_sdcc_status.index == 29) gLte_sdcc_status.index = 0;
	else gLte_sdcc_status.index++;
	printk("[LTE_INFO] Control write");
...
/*MOD 0019235:  [LTE] Monitoring code & LTE Crash Dump Handling */
	switch(cmd)
	{
		case IOCTL_WRITE_H_VAL :
			#ifdef SDCC_STATUS_MONITORING
			printk("*************** SDIO IOCTL ( IOCTL_WRITE_H_VAL ) *********************\n");
			#endif /* SDCC_STATUS_MONITORING */
			sdio_claim_host(gLte_sdio_info->func);			
		...
		case IOCTL_READ_L_VAL :
			#ifdef SDCC_STATUS_MONITORING
			printk("*************** SDIO IOCTL ( IOCTL_READ_L_VAL ) *********************\n");
			#endif /* SDCC_STATUS_MONITORING */
			sdio_claim_host(gLte_sdio_info->func);			
		...
		case IOCTL_READ_HIM_TX_CNT :
			#ifdef SDCC_STATUS_MONITORING
			printk("*************** SDIO IOCTL ( IOCTL_READ_HIM_TX_CNT ) *********************\n");
			#endif /* SDCC_STATUS_MONITORING */
		...
		case IOCTL_READ_HIM_RX_CNT :
			#ifdef SDCC_STATUS_MONITORING
			printk("*************** SDIO IOCTL ( IOCTL_READ_HIM_RX_CNT ) *********************\n");
			#endif /* SDCC_STATUS_MONITORING */
		...
		case IOCTL_LTE_PWR_ON :
			#ifdef SDCC_STATUS_MONITORING
			printk("*************** SDIO IOCTL ( IOCTL_LTE_PWR_ON ) *********************\n");
			#endif /* SDCC_STATUS_MONITORING */
...
/*MOD 0019235:  [LTE] Monitoring code & LTE Crash Dump Handling */
			#ifdef SDCC_STATUS_MONITORING
			printk("*************** SDIO IOCTL ( IOCTL_LTE_PWR_OFF ) *********************\n");
			#endif /* SDCC_STATUS_MONITORING */
/*END: 0019235 seongmook.yim@lge.com 2011-07-07 */
/*BEGIN: 0014925 daeok.kim@lge.com 2011-01-27 */
/*ADD 0014925: [LTE] HWRev_val is added due to overloading of RPC in the calling CheckHWRev() */
...
/*MOD 0019235:  [LTE] Monitoring code & LTE Crash Dump Handling */
			#ifdef SDCC_STATUS_MONITORING
			printk("*************** SDIO IOCTL ( IOCTL_LTE_GPIO_PWR_OFF ) *********************\n");
			#endif /* SDCC_STATUS_MONITORING */
/*END: 0019235 seongmook.yim@lge.com 2011-07-07 */
...
/*MOD 0019235:  [LTE] Monitoring code & LTE Crash Dump Handling */
			#ifdef SDCC_STATUS_MONITORING
			printk("*************** SDIO IOCTL ( IOCTL_LTE_SDIO_RESCAN ) *********************\n");
			#endif /* SDCC_STATUS_MONITORING */
/*END: 0019235 seongmook.yim@lge.com 2011-07-07 */
...
/*MOD 0019235:  [LTE] Monitoring code & LTE Crash Dump Handling */
			#ifdef SDCC_STATUS_MONITORING
			printk("*************** SDIO IOCTL ( IOCTL_LTE_SDIO_BOOT ) *********************\n");
			#endif /* SDCC_STATUS_MONITORING */
/*END: 0019235 seongmook.yim@lge.com 2011-07-07 */
			/* LTE SDIO boot */
...
/*MOD 0019235:  [LTE] Monitoring code & LTE Crash Dump Handling */
			#ifdef SDCC_STATUS_MONITORING
			printk("*************** SDIO IOCTL ( IOCTL_LTE_TEST ) *********************\n");
			#endif /* SDCC_STATUS_MONITORING */
/*END: 0019235 seongmook.yim@lge.com 2011-07-07 */
