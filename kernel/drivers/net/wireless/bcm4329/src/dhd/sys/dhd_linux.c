...
{
/* LGE_CHANGE_S, [dongp.kim@lge.com, 2010-10-13, Envy T2 migration for bug fix: multicast packet lost/wifi throughput down */
#if 0
	...
	int bcn_li_dtim = 3;
#endif
/* LGE_CHANGE_E, [dongp.kim@lge.com, 2010-10-13, Envy T2 migration for bug fix: multicast packet lost/wifi throughput down */
