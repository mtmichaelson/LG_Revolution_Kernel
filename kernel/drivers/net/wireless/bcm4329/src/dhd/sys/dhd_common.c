...
//ADD: 0014535: [Wi-Fi] In order to prevent Wi-Fi disassociation when MAC is rewritten
/* LGE_CHANGE_S, [dongp.kim@lge.com], 2011-01-21, in case that the phone is suspend/resumed after MAC is rewritten, Wi-Fi is disassociated */
#if 0
...
#endif
/* LGE_CHANGE_E, [dongp.kim@lge.com], 2011-01-21, in case that the phone is suspend/resumed after MAC is rewritten, Wi-Fi is disassociated */
//END: 0014535: [Wi-Fi] In order to prevent Wi-Fi disassociation when MAC is rewritten
