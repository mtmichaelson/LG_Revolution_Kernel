...
#endif	/* !define(CONFIG_LGE_BCM432X_PATCH) */
...
//ADD: 0013225: [Wi-Fi] when Wi-Fi on, sicne kernel crash is occurred, back to the orignal 
/* LGE_CHANEG_S, [dongp.kim@lge.com, 2010-12-29, back to the orignal because of side effect by patch */
		leaf = kmalloc(bi->length + WLC_IW_SS_CACHE_CTRL_FIELD_MAXLEN, GFP_KERNEL);
/* LGE_CHANEG_E, [dongp.kim@lge.com, 2010-12-29, back to the orignal because of side effect by patch */
//END: 0013225: [Wi-Fi] when Wi-Fi on, sicne kernel crash is occurred, back to the orignal 
	...
	struct iw_request_info *info, wl_bss_info_t *bi)
{
	...
	*event_p = event;
	...
	if(buf != NULL)		//by sjpark 11-01-25 WBT : ID 196408
		kfree(buf);
	}
#endif 
...
/* 20110818 cheolsook.lee@lge.com [Wi-Fi] to succeed DHCP procedure after wakeup [START] */
#if defined(CONFIG_BRCM_LGE_WL_ARPOFFLOAD)
	    {
...
/* 20110818 cheolsook.lee@lge.com [Wi-Fi] to succeed DHCP procedure after wakeup [END] */
