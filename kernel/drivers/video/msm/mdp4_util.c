...
extern int mdp_overlay_pwr_acc0;
#endif
...
void mdp4_hw_init(void)
{
    ...
    /* LGE_S    jihye.ahn@lge.com    2011-02-22   
     *enhanced camera preview quailty 
     */
    mdp4_dmap_lut_setup(0);
    mdp4_dmap_lut_setup(1);
    /* LGE_E    jihye.ahn@lge.com    2011-02-22 */  
...
void mdp4_dmap_lut_setup(int vp_num)
{
	unsigned char *base;
	int i, voff, off;
	uint32 data, val;
        ...
        voff = 0x400*vp_num;
        base = MDP_BASE + 0x94800 + voff;

        MDP_OUTP(MDP_BASE + 0x90070, (0 << 10) | 0x17);
