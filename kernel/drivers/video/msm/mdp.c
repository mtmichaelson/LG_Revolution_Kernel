...
/*  QCT case number 00470946  
     		to fix sleep current problem in camera preview mode - chanhee.park@lge.com */
#ifdef CONFIG_MACH_LGE_BRYCE       
int mdp_overlay_pwr_acc0;
EXPORT_SYMBOL(mdp_overlay_pwr_acc0);
#endif
...
void mdp_hw_version(void)
{
	...
	/* HW version updated from hw revision address. kiran.kanneganti*/
...
/* jihye.ahn@lge.com 2011-01-22 SBA203007 */
//	mdp_debugfs_init();
#endif
