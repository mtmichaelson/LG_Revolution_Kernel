...
static ssize_t hdmi_common_rda_power_state(struct device *dev,
	struct device_attribute *attr, char *buf)
{
	ssize_t ret = snprintf(buf, PAGE_SIZE, "%d\n",
...
/* LGE_CHANGE_S [jaeho.cho@lge.com] 2011-07-06, Add power_state for NXP HDMI module build */
#ifdef CONFIG_LGE_HDMI_MODULE_BUILD
#else
extern int change_hdmi_power(int);
#endif
/* LGE_CHANGE_S [jaeho.cho@lge.com] 2011-07-06, Add power_state for NXP HDMI module build */
...
//Suresh: CTSPerms fail fix
static DEVICE_ATTR(video_mode, S_IRUGO | S_IWGRP | S_IWUSR /*S_IWUGO*/,
...
//Suresh: CTSPerms fail fix
static DEVICE_ATTR(hpd, S_IRUGO | S_IWGRP | S_IWUSR /*S_IWUGO*/, hdmi_common_rda_hpd,
	hdmi_common_wta_hpd);
static DEVICE_ATTR(hdcp, S_IRUGO, hdmi_common_rda_hdcp, NULL);
#endif
#ifdef CONFIG_FB_MSM_HDMI_3D
//Suresh: CTSPerms fail fix
static DEVICE_ATTR(format_3d, S_IRUGO | S_IWGRP | S_IWUSR /*S_IWUGO*/, hdmi_3d_rda_format_3d,
	hdmi_3d_wta_format_3d);
#endif
/* jaeseong.gim 10.09.16
 * added hdmi power state file
 */
#ifdef CONFIG_MACH_LGE_BRYCE
//Suresh: CTSPerms fail fix
static DEVICE_ATTR(power_state, S_IRUGO | S_IWGRP | S_IWUSR /*S_IWUGO*/, hdmi_common_rda_power_state,
	hdmi_common_wta_power_state);
#endif
