...
static int bd6084gu_probe(struct i2c_client *i2c_dev, const struct i2c_device_id *i2c_dev_id)
{
...
static const struct i2c_device_id bd6084gu_ids[] = {
	{ MODULE_NAME, 0 },
	{ },		
};
MODULE_DEVICE_TABLE(i2c, bd6084gu_ids);

static struct i2c_driver bd6084gu_driver = {
	.driver.name	= MODULE_NAME,
	.id_table	= bd6084gu_ids,		
...
{
	int rc = i2c_add_driver(&bd6084gu_driver);
...
MODULE_DESCRIPTION("BD6084GU driver");
MODULE_VERSION("1.0");
MODULE_ALIAS("platform:BD6084GU");
