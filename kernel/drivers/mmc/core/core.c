...
// END : munho.lee@lge.com 2010-12-27
{
	 ...
	 */
/* Begin :[naveen.amarendra@lge.com] SDCARD Ramp up time change from MS910 */
#if 1
    /* Change delay from 10 to 250: SD 2.0 Spec 6.4 - ramp up time should be at least 250ms */
	if (!strcmp(mmc_hostname(host), "mmc3"))
		mmc_delay(50);
	else
		mmc_delay(10);
	...
	mmc_delay(10);
#endif
/* End :[naveen.amarendra@lge.com] SDCARD Ramp up time change from MS910 */
...
// BEGIN : munho.lee@lge.com 2010-12-27
// ADD: 0013091: SD card stability patch 
