...
/*BEGIN: 0012563 daeok.kim@lge.com 2010-12-16 */
/*ADD 0012563: [LTE] LTE SDIO driver suspend/resume skip when system suspend/resume */ 
#define GPIO_LTE_SDIO_RESET 157
/*END: 0012563 daeok.kim@lge.com 2010-12-16 */
...
/*MOD 0019235:  [LTE] Monitoring code & LTE Crash Dump Handling */
#ifdef SDCC_STATUS_MONITORING
	gLte_sdcc_status.tracking[gLte_sdcc_status.index] = enum_msmsdcc_stop_data;
...
/*MOD 0019235:  [LTE] Monitoring code & LTE Crash Dump Handling */
#ifdef SDCC_STATUS_MONITORING
		gLte_sdcc_status.tracking[gLte_sdcc_status.index] = enum_msmsdcc_start_command_exec;
		if(gLte_sdcc_status.index == 29) gLte_sdcc_status.index = 0;
		else gLte_sdcc_status.index++;
#endif /* SDCC_STATUS_MONITORING */
/*END: 0019235 seongmook.yim@lge.com 2011-07-07 */
...
/*MOD 0019235:  [LTE] Monitoring code & LTE Crash Dump Handling */
	#ifdef SDCC_STATUS_MONITORING
	gLte_sdcc_status.tracking[gLte_sdcc_status.index] = enum_msmsdcc_dma_exec_func;
	if(gLte_sdcc_status.index == 29) gLte_sdcc_status.index = 0;
		else gLte_sdcc_status.index++;
	#endif /* SDCC_STATUS_MONITORING */
/*END: 0019235 seongmook.yim@lge.com 2011-07-07 */
...
/*MOD 0019235:  [LTE] Monitoring code & LTE Crash Dump Handling */
#ifdef SDCC_STATUS_MONITORING
	gLte_sdcc_status.tracking[gLte_sdcc_status.index] = enum_msmsdcc_dma_complete_tlet;
	if(gLte_sdcc_status.index == 29) gLte_sdcc_status.index = 0;
		else gLte_sdcc_status.index++;
#endif /* SDCC_STATUS_MONITORING */
/*END: 0019235 seongmook.yim@lge.com 2011-07-07 */
...
/*MOD 0019235:  [LTE] Monitoring code & LTE Crash Dump Handling */
#ifdef SDCC_STATUS_MONITORING
		gLte_sdcc_status.tracking[gLte_sdcc_status.index] = enum_msmsdcc_dma_complete_func;
		if(gLte_sdcc_status.index == 29) gLte_sdcc_status.index = 0;
		else gLte_sdcc_status.index++;
#endif /* SDCC_STATUS_MONITORING */
/*END: 0019235 seongmook.yim@lge.com 2011-07-07 */
...
/*MOD 0019235:  [LTE] Monitoring code & LTE Crash Dump Handling */
#ifdef SDCC_STATUS_MONITORING
	gLte_sdcc_status.tracking[gLte_sdcc_status.index] = enum_msmsdcc_config_dma;
	if(gLte_sdcc_status.index == 29) gLte_sdcc_status.index = 0;
		else gLte_sdcc_status.index++;
#endif /* SDCC_STATUS_MONITORING */
/*END: 0019235 seongmook.yim@lge.com 2011-07-07 */
...
/*MOD 0019235:  [LTE] Monitoring code & LTE Crash Dump Handling */
#ifdef SDCC_STATUS_MONITORING
	gLte_sdcc_status.tracking[gLte_sdcc_status.index] = enum_msmsdcc_start_data;
	if(gLte_sdcc_status.index == 29) gLte_sdcc_status.index = 0;
		else gLte_sdcc_status.index++;
#endif /* SDCC_STATUS_MONITORING */
/*END: 0019235 seongmook.yim@lge.com 2011-07-07 */
...
/*MOD 0019235:  [LTE] Monitoring code & LTE Crash Dump Handling */
#ifdef SDCC_STATUS_MONITORING
	gLte_sdcc_status.tracking[gLte_sdcc_status.index] = enum_msmsdcc_data_err;
	if(gLte_sdcc_status.index == 29) gLte_sdcc_status.index = 0;
		else gLte_sdcc_status.index++;
#endif /* SDCC_STATUS_MONITORING */
/*END: 0019235 seongmook.yim@lge.com 2011-07-07 */
...
/*MOD 0019235:  [LTE] Monitoring code & LTE Crash Dump Handling */
#ifdef SDCC_STATUS_MONITORING
		gLte_sdcc_status.tracking[gLte_sdcc_status.index] = enum_msmsdcc_request_start;
		if(gLte_sdcc_status.index == 29) gLte_sdcc_status.index = 0;
		else gLte_sdcc_status.index++;
#endif /* SDCC_STATUS_MONITORING */
/*END: 0019235 seongmook.yim@lge.com 2011-07-07 */
...
/*MOD 0019235:  [LTE] Monitoring code & LTE Crash Dump Handling */
#ifdef SDCC_STATUS_MONITORING
	gLte_sdcc_status.tracking[gLte_sdcc_status.index] = enum_msmsdcc_request;
	if(gLte_sdcc_status.index == 29) gLte_sdcc_status.index = 0;
		else gLte_sdcc_status.index++;
#endif /* SDCC_STATUS_MONITORING */
/*END: 0019235 seongmook.yim@lge.com 2011-07-07 */
...
//ADD: 0018499: [Wi-Fi] avoiding Wi-Fi error when to try Wi-Fi on occuring by 150ms delay during Wi-Fi off 
// LGE_CHANGES_S [dongp.kim@lge.com] 2010-03-24, reducing 150ms delay when Wi-Fi off
// LGE_CHANGES_S [dongp.kim@lge.com] 2010-01-23 [VS910] Add bcm4329
			...
			if ((host->plat->status_irq == MSM_GPIO_TO_INT(CONFIG_BCM4329_GPIO_WL_RESET)) && status) 
			{
				...
				{
					mmc_detect_change(host->mmc, 0);
					printk(KERN_INFO "Wi-Fi off & delay 0ms\n");
				}
				else
				{
...
// LGE_CHANGES_E [dongp.kim@lge.com] 2010-01-23 [VS910] Add bcm4329
// LGE_CHANGES_E [dongp.kim@lge.com] 2010-03-24, reducing 150ms delay when Wi-Fi off
//END: 0018499: [Wi-Fi] avoiding Wi-Fi error when to try Wi-Fi on occuring by 150ms delay during Wi-Fi off 
		}
		host->oldstat = status;
	}
}
...
/* BEGIN: 0010047: jihyun.park@lge.com 2010-12-19  */
/* [LTE] Wakeup Scheme  for Power Saving Mode   */
extern int wakeup_rx_resume(void);
extern int wakeup_rx_suspend(void);
/* END: 0010047: jihyun.park@lge.com 2010-12-19 */   
...
msmsdcc_runtime_suspend(struct device *dev)
{
	...
	if (mmc) {
		 ...
		 */
//ADD: 0012730: [Wi-Fi] prevent suspend error when Wi-Fi on
//LGE_CHANGE_S, [dongp.kim@lge.com], 2010-12-20, prevent suspend fail when Wi-Fi on 
/*BEGIN: 0012563 daeok.kim@lge.com 2010-12-16 */
/*ADD 0012563: [LTE] LTE SDIO driver suspend/resume skip when system suspend/resume */ 
//ADD: 0012061: [Wi-Fi] suspend/resume patch due to kernel crash 
//LGE_CHANGE_S, [dongp.kim@lge.com], 2010-12-09, WiFi suspend skip when system suspend 

//		if ( mmc->card && mmc->card->type != MMC_TYPE_SDIO) {
		if (host->plat->status_irq != MSM_GPIO_TO_INT(CONFIG_BCM4329_GPIO_WL_RESET)) 
		{
			if(host->plat->status_irq !=MSM_GPIO_TO_INT(GPIO_LTE_SDIO_RESET)) {
				pm_runtime_get_noresume(dev);
...
//LGE_CHANGE_S, [dongp.kim@lge.com], 2010-12-20, prevent suspend fail when Wi-Fi on 
//ADD:0011052
// LGE_CHANGE_S, [dongp.kim@lge.com], 2010-11-16, reduce power consumption by Wi-Fi 
#if 0
			if (mmc->card && (mmc->card->type == MMC_TYPE_SDIO) &&
				(mmc->pm_flags & MMC_PM_WAKE_SDIO_IRQ)) {
		...
		if ( (mmc->pm_flags & MMC_PM_WAKE_SDIO_IRQ) && mmc->card &&
				...
				host->plat->status_irq != MSM_GPIO_TO_INT(CONFIG_BCM4329_GPIO_WL_RESET)) 
		{	 
				if(host->plat->status_irq !=MSM_GPIO_TO_INT(GPIO_LTE_SDIO_RESET))				
				{
//ADD: 0017360: [Wi-Fi] deleting debug code for production version
/* LGE_CHANGE_S. [dongp.kim@lge.com], 2011-03-03, deleting debug code for production version */
//					printk("[WiFi], dongp.kim@lge.com %s: host->sdio_irq_disabled \n",__FUNCTION__);
/* LGE_CHANGE_E. [dongp.kim@lge.com], 2011-03-03, deleting debug code for production version */
//END: 0017360: [Wi-Fi] deleting debug code for production version
					host->sdio_irq_disabled = 0;
...
#endif
// LGE_CHANGE_E, [dongp.kim@lge.com], 2010-11-16, reduce power consumption by Wi-Fi 
//END:0011052
//LGE_CHANGE_E, [dongp.kim@lge.com], 2010-12-20, prevent suspend fail when Wi-Fi on 
//END: 0012730: [Wi-Fi] prevent suspend error when Wi-Fi on
...
//LGE_CHANGE_S, [dongp.kim@lge.com], 2010-12-09, WiFi suspend skip when system suspend 
		...
		if ((mmc->pm_flags & MMC_PM_WAKE_SDIO_IRQ) &&
				!host->sdio_irq_disabled && host->plat->status_irq != MSM_GPIO_TO_INT(CONFIG_BCM4329_GPIO_WL_RESET)) {

				if(host->plat->status_irq !=MSM_GPIO_TO_INT(GPIO_LTE_SDIO_RESET))
				{
//LGE_CHANGE_E, [dongp.kim@lge.com], 2010-12-09, WiFi suspend skip when system suspend 
//END: 0012061: [Wi-Fi] suspend/resume patch due to kernel crash 
/*END: 0012563 daeok.kim@lge.com 2010-12-16 */
