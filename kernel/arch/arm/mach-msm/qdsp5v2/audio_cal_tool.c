...
struct volumelevel handset_rx[2] 		= {{100,-2200},{100,-2200}};
...
/* BEGIN:0018469        ehgrace.kim@lge.com     2011.03.23*/
/* MOD: add the rx volume min/max fill function in hidden menu 
 */

void fill_rxvol_table()
{
	handset_rx[VOC_NB_INDEX].max_level = snddev_iearpiece_data.max_voice_rx_vol[VOC_NB_INDEX];
	handset_rx[VOC_NB_INDEX].min_level = snddev_iearpiece_data.min_voice_rx_vol[VOC_NB_INDEX];
	handset_rx[VOC_WB_INDEX].max_level = snddev_iearpiece_data.max_voice_rx_vol[VOC_WB_INDEX];
	handset_rx[VOC_WB_INDEX].min_level = snddev_iearpiece_data.min_voice_rx_vol[VOC_WB_INDEX];	
		
	headset_stereo_rx[VOC_NB_INDEX].max_level = snddev_ihs_stereo_rx_data.max_voice_rx_vol[VOC_NB_INDEX];
	headset_stereo_rx[VOC_NB_INDEX].min_level = snddev_ihs_stereo_rx_data.min_voice_rx_vol[VOC_NB_INDEX];
	headset_stereo_rx[VOC_WB_INDEX].max_level = snddev_ihs_stereo_rx_data.max_voice_rx_vol[VOC_WB_INDEX];
	headset_stereo_rx[VOC_WB_INDEX].min_level = snddev_ihs_stereo_rx_data.min_voice_rx_vol[VOC_WB_INDEX];
	
	headset_mono_rx[VOC_NB_INDEX].max_level = snddev_ihs_mono_rx_data.max_voice_rx_vol[VOC_NB_INDEX];
	headset_mono_rx[VOC_NB_INDEX].min_level = snddev_ihs_mono_rx_data.min_voice_rx_vol[VOC_NB_INDEX];
	headset_mono_rx[VOC_WB_INDEX].max_level = snddev_ihs_mono_rx_data.max_voice_rx_vol[VOC_WB_INDEX];
	headset_mono_rx[VOC_WB_INDEX].min_level = snddev_ihs_mono_rx_data.min_voice_rx_vol[VOC_WB_INDEX];

	spk_rx[VOC_NB_INDEX].max_level = snddev_ispeaker_rx_data.max_voice_rx_vol[VOC_NB_INDEX];
	spk_rx[VOC_NB_INDEX].min_level = snddev_ispeaker_rx_data.min_voice_rx_vol[VOC_NB_INDEX];
	spk_rx[VOC_WB_INDEX].max_level = snddev_ispeaker_rx_data.max_voice_rx_vol[VOC_WB_INDEX];
	spk_rx[VOC_WB_INDEX].min_level = snddev_ispeaker_rx_data.min_voice_rx_vol[VOC_WB_INDEX];	

	headset_spk_rx[VOC_NB_INDEX].max_level = snddev_ihs_stereo_speaker_stereo_rx_data.max_voice_rx_vol[VOC_NB_INDEX];
	headset_spk_rx[VOC_NB_INDEX].min_level = snddev_ihs_stereo_speaker_stereo_rx_data.min_voice_rx_vol[VOC_NB_INDEX];
	headset_spk_rx[VOC_WB_INDEX].max_level = snddev_ihs_stereo_speaker_stereo_rx_data.max_voice_rx_vol[VOC_WB_INDEX];
	headset_spk_rx[VOC_WB_INDEX].min_level = snddev_ihs_stereo_speaker_stereo_rx_data.min_voice_rx_vol[VOC_WB_INDEX];

	BT_earpiece_rx[VOC_NB_INDEX].max_level = snddev_bt_sco_earpiece_data.max_voice_rx_vol[VOC_NB_INDEX];
	BT_earpiece_rx[VOC_NB_INDEX].min_level = snddev_bt_sco_earpiece_data.min_voice_rx_vol[VOC_NB_INDEX];
	BT_earpiece_rx[VOC_WB_INDEX].max_level = snddev_bt_sco_earpiece_data.max_voice_rx_vol[VOC_WB_INDEX];
	BT_earpiece_rx[VOC_WB_INDEX].min_level = snddev_bt_sco_earpiece_data.min_voice_rx_vol[VOC_WB_INDEX];

	spk_stereo_rx[VOC_NB_INDEX].max_level = snddev_ispeaker_phone_rx_data.max_voice_rx_vol[VOC_NB_INDEX];
	spk_stereo_rx[VOC_NB_INDEX].min_level = snddev_ispeaker_phone_rx_data.min_voice_rx_vol[VOC_NB_INDEX];
	spk_stereo_rx[VOC_WB_INDEX].max_level = snddev_ispeaker_phone_rx_data.max_voice_rx_vol[VOC_WB_INDEX];
	spk_stereo_rx[VOC_WB_INDEX].min_level = snddev_ispeaker_phone_rx_data.min_voice_rx_vol[VOC_WB_INDEX];	
}
/* END:0018469        ehgrace.kim@lge.com     2011.03.23*/
