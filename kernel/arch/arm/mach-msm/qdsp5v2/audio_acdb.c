...
{
	s32 result = 0;
/* BEGIN:0018087 	ehgrace.kim@lge.com 	2011.03.16*/
/* ADD: [Audio] address logical issues in ACDB driver as QCT SBA Patch */
#if 1
...
#endif
/* END:0018087 	ehgrace.kim@lge.com 	2011.03.16*/
done:
	return result;
}
