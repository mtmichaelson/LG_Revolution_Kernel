...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 1, 576000,  PLL_1, 2, 0,  153600000, 925, VDD_RAW(925) },
	...
	{ 1, 921600,  PLL_2, 3, 0, UINT_MAX, 1075, VDD_RAW(1075), &pll2_tbl[1]},
	{ 1, 1024000, PLL_2, 3, 0, UINT_MAX, 1100, VDD_RAW(1100), &pll2_tbl[2]},
	{ 1, 1113000, PLL_2, 3, 0, UINT_MAX, 1125, VDD_RAW(1125), &pll2_tbl[3]},
