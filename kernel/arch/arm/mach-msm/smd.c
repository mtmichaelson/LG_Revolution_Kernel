 ...
 * 0010516: add modem dump feature
*/
...
extern char crash_buf[LGE_ERROR_MAX_ROW][LGE_ERROR_MAX_COLUMN];
#endif
#endif
...
#if 1//def CONFIG_LGE_HANDLE_MODEM_CRASH
...
#if defined(CONFIG_ANDROID_RAM_CONSOLE)
	sprintf(crash_buf[1],"---------------------------------------");
	sprintf(crash_buf[2], "Modem crash ");
	sprintf(crash_buf[3], "--------------------------------------");

	//ret = LGE_ErrorHandler_Main(MODEM_CRASH, crash_buf);
...
/* BEGIN: 0014783 hyogook.lee@lge.com 2011-01-25 */
/* ADD: 0014783: [Booting] Chargerlogo Enter Condition Change Merged*/
#if 1//def CONFIG_LGE_MACH_ENVT2 //THUNDER_MIGRATION
