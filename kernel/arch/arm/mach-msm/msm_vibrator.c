...
//sairam.valasala@lge.com added for vibrator implementation
#define PM_VIB_MOT_SET_VOLT_PROC	22 //sungwoo.cho
#define PMIC_VIBRATOR_LEVEL	(3000)
//sairam.valasala@lge.com added for vibrator implementation ::start
...
//sairam.valasala@lge.com for vibrator implementation ::end
#else
...
//sairam.valasala@lge.com for vibrator implementation ::start
#if 1
	msm_rpc_call(vib_endpoint, PM_VIB_MOT_SET_VOLT_PROC, &req,
		sizeof(req), 5 * HZ);
#else
