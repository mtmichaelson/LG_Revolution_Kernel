...
// LGE_CHANGE_START 2011-02-19 0016485: [VS910][Android][UTS] fix the keycode on UTS test in lg_diag_keypress.c kenneth.kang@lge.com
    ...
    {0x204D     ,   KEY_M},  {0x214E     ,   KEY_N}, {0x214F     ,   KEY_O},   {0x2150     ,   KEY_P}, 
    {0x2151     ,   KEY_Q},  {0x2052     ,   KEY_R}, {0x2053     ,   KEY_S},   {0x2054     ,   KEY_T}, 
    {0x2055     ,   KEY_U},  {0x2056     ,   KEY_V}, {0x2057     ,   KEY_W},  {0x2058     ,   KEY_X}, 
    {0x2059     ,   KEY_Y},  {0x205A     ,   KEY_Z}, 
// LGE_CHANGE_END 2011-02-19 kenneth.kang@lge.com
